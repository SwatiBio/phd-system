  ...
  <nav aria-label="Sidebar navigation">
    <header>
      <a href="/" class="flex items-center gap-2">
        <span class="sidebar-title">PhD-OS</span>
      </a>
    </header>
...
<div class="app-bar">
  <div class="app-bar-side">
    <button type="button" class="btn" data-variant="ghost" data-size="icon-sm" aria-label="Open navigation"
  ...
  <div class="app-bar-side">
    <button type="button" class="btn" data-variant="ghost" data-size="icon-sm" id="theme-toggle" aria-label="Toggle dark mode"
